...
export default function AviationPage() {
  ...
  return (
    <div className="bg-white text-[#1d1d1f] min-h-screen pb-24 selection:bg-accent/20 selection:text-[#1d1d1f]">
      ...
      <PageIntro
        eyebrow="DCAA Licensed Aviation Operators"
        badge={<SourceBadge status="LICENSED OPERATOR" sourceName="Dubai Civil Aviation Authority" />}
        title={<>Private Aviation & FBO<span className="text-gradient-gold">.</span></>}
        description="VIP Fixed Base Operators (FBO), private jet charters, and certified commercial helicopter transfers operating at Al Maktoum International (DWC) and Dubai International (DXB)."
      />
          ...
          {aviationList.map((item) => (
            ...
            >
              <div className="space-y-5">
                ...
                <div className="pt-2">
                  <span className="text-[10px] font-mono uppercase tracking-widest text-[#6e6e73] font-semibold block mb-1">Tariff / Charter Structure</span>
