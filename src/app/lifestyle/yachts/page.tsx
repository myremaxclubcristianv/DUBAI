          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold uppercase tracking-widest text-accent font-mono">
                DMCA LICENSED CHARTERS
              </span>
              <SourceBadge status="LICENSED OPERATOR" sourceName="Dubai Maritime City Authority" />
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white tracking-tight mt-2">
              Superyachts & Marine Charters
            </h1>
            <p className="text-xs sm:text-sm text-zinc-400 mt-2 max-w-2xl">
              Licensed luxury motor yacht and superyacht charters departing Dubai Marina and Dubai Harbour.
            </p>
          </div>
        </div>
