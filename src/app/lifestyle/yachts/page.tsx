...
export default function YachtsPage() {
  const yachtList = VERIFIED_LIFESTYLE.filter((l) => l.category === 'yachts')

  return (
    <div className="bg-white text-[#1d1d1f] min-h-screen pb-24 selection:bg-accent/20 selection:text-[#1d1d1f]">
      {/* 1. CENTERED PAGE INTRO */}
      <PageIntro
        eyebrow="DMCA Licensed Marine Operators"
        badge={<SourceBadge status="LICENSED OPERATOR" sourceName="Dubai Maritime City Authority" />}
        title={<>Superyachts & Charters<span className="text-gradient-gold">.</span></>}
        description="Licensed luxury motor yacht and superyacht charters, private berth reservations, and bespoke marine itineraries departing Dubai Marina Yacht Club and Dubai Harbour."
      />
            ...
            >
              <div className="space-y-5">
                <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-[#f5f5f7]">
                  <Image
                    src={item.image || 'https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&w=1200&q=80'}
                    alt={item.title}
                    fill
                ...
                <div className="pt-2">
                  <span className="text-[10px] font-mono uppercase tracking-widest text-[#6e6e73] font-semibold block mb-1">Charter Tariffs</span>
              ...
              {item.official_url && (
                <div className="pt-4 border-t border-black/10">
                  ...
                  >
                    <span>Operator Yacht Fleet Portal</span>
