  ...
  return (
    <div className="bg-white text-[#1d1d1f] min-h-screen pb-24 selection:bg-accent/20 selection:text-[#1d1d1f]">
      ...
      <PageIntro
        ...
        title={<>Conservation Desert Safaris<span className="text-gradient-gold">.</span></>}
          ...
          {safariList.map((item) => (
            ...
            >
              <div className="space-y-5">
                ...
                <div className="pt-2">
                  <span className="text-[10px] font-mono uppercase tracking-widest text-[#6e6e73] font-semibold block mb-1">Expedition Tariffs</span>
